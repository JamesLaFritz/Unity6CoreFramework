...
{
    /// <summary>
    /// Provides extension methods for Unity GameObjects to simplify common operations
    /// such as managing components, transformations, hierarchy, and more.
    /// </summary>
    public static class GameObjectExtensions
    {
        ...
        /// can incorrectly return true for destroyed objects, leading to misleading behavior. The OrNull method uses
