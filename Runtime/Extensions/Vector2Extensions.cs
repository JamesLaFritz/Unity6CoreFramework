...
{
    /// <summary>
    /// Provides extension methods for the UnityEngine.Vector2 structure,
    /// enabling additional functionality such as component modifications,
    /// range checks, and generating random points within specified areas.
    /// </summary>
    public static class Vector2Extensions
    {
        ...
        public static Vector2 RandomPointInAnnulus(this Vector2 origin, float minRadius, float maxRadius)
        {
            ...
            var distance = Mathf.Sqrt(UnityEngine.Random.value * (maxRadiusSquared - minRadiusSquared) + minRadiusSquared);
