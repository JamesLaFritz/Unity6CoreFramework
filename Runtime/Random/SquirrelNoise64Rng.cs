...
namespace CoreFramework.Random
{
    ...
    public struct SquirrelNoise64Rng : IRandomFunction<ulong, ulong>
    {
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float Perlin(float x, float y) => SquirrelNoise64Bit.Perlin(x, y, Seed, Type);
        ...
        /// </returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float Perlin(float x, float y, float z) => SquirrelNoise64Bit.Perlin(x, y, z, Seed, Type);
